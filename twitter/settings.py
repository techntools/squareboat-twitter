...
from utils.helpers import asarray
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', cast=asarray)
...
CORS_ORIGIN_WHITELIST = config('CORS_ORIGIN_WHITELIST', cast=asarray)

REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        'utils.renderers.ResponseJSONRenderer',
